...
const Milestones = ({
  ...
  return (
    <>
      <Milestone currentStep={currentStep} />
      <>
...
const Milestone = ({ currentStep }: { currentStep: number }) => {
  if (currentStep + 1 === 1)
    return (
      <div className='whitespace-pre-wrap'>
        ...
        <br />
        <br />
        1) Upload Aim: The student uploads a document or statement that clearly
        defines the aim or objective of their project. This provides a clear
        understanding of what they intend to achieve through their work, setting
        the direction for the project.
        <br />
        <br />
        2) Upload Description: The student uploads a detailed description of
        their project, outlining the scope, methodology, and expected outcomes.
        This document provides a comprehensive overview of the project,
        including its purpose, approach, and expected deliverables.
        <br />
        <br />
        3) Upload Your Input in this Project: The student uploads a document or
        description highlighting their individual contribution to the project.
        This could include their research findings, innovative ideas, analysis,
        or any specific tasks they have undertaken. It demonstrates their unique
  ...
  if (currentStep + 1 === 2)
    return (
      <div className='whitespace-pre-wrap'>
        <h3 className='text-lg font-bold'>Stage (2): (In Suitable Formats)</h3>
        <br />
        ...
        project. This provides a visual representation of the electrical system
        or components involved, demonstrating their understanding of electrical
        engineering principles.
        <br />
        <br />
        3) Civil Engineering: The student uploads structural diagrams or
        drawings related to the project. This could include architectural plans,
        structural designs, or any other documentation that showcases the civil
        engineering aspects of the project, such as building layouts or
        ...
        system architecture diagrams, or any other documentation related to the
        IT and communication aspects of the project. This demonstrates their
        expertise in software development, networking, or other IT-related
        fields.
        <br />
        <br />
        Note: For other engineering fields, students are required to upload
        project plans or diagrams specific to their field, highlighting the key
        aspects and methodologies relevant to their discipline.
      </div>
    );
  if (currentStep + 1 === 3)
    return (
  ...
  if (currentStep + 1 === 4)
    return (
      <div className='whitespace-pre-wrap'>
        ...
        <br />
        -Upload a Short Video: The student and their team members create a short
        video (maximum 3 minutes) showcasing their project. The video should
        highlight the key features, functionality, and achievements of the
        project. It can include demonstrations, explanations, and interviews
        with team members to provide a comprehensive overview. The video helps
        in visually presenting the project&#39;s outcomes and engaging the
        audience.
        <br />
      </div>
    );
  if (currentStep + 1 === 5)
    return (
      <div className='whitespace-pre-wrap'>
        ...
        include all the details of the project, including the aim, description,
        methodology, results, analysis, conclusions, and future recommendations.
        It should serve as a complete record of the project&#39;s objectives,
  ...
  if (currentStep + 1 === 6)
    return (
      <div className='whitespace-pre-wrap'>
        ...
        partner. This certificate serves as verification of their participation
        in an industrial setting and validates their experience and skills
        gained during the project. It adds credibility to the student&#39;s
        profile and showcases their industry-relevant expertise.
        <br />
        <br />
        Please note that the formats mentioned (PPT, PDF, .MP4) are suggested
        file formats for uploading the respective documents and videos. Students
        may need to follow specific guidelines or requirements provided by their
        institution or project mentor.
        <br />
      </div>
    );
  if (currentStep + 1 > 6)
